...
public class PayPwdInputView extends AppCompatEditText {
    ...
    private final static int DEFAULT_HEIGHT = RxImageTool.dp2px(45);

    /**
     * 实心圆的半径
     */
    private float pwdRadius = RxImageTool.dp2px(6);
     ...
     * 圆或文字的颜色   默认BLACK
     */
    private float textSize = RxImageTool.sp2px(18);
     ...
     * 分割线的宽度  默认1dp
     */
    private float divideLineWidth = RxImageTool.dp2px(1);
...
//    }
    ...
    private void drawText(Canvas canvas) {
        ...
        // 画文字
        List<String> list = DensityUtils.subStringToList(getPasswordString());

...
package com.ggb.nirvanaclub.view.emojitextview;
...
//        sQQFaceMap.put("[投降]", R.drawable.expression_100);
        ...
        sQQFaceMap.put("[老鼠]", R.drawable.emoji_1f400);
        sQQFaceMap.put("[白鼠]", R.drawable.emoji_1f401);
        sQQFaceMap.put("[Ikun]", R.drawable.emoji_1f413);
        sQQFaceMap.put("[蔡徐坤]", R.drawable.emoji_1f414);
        sQQFaceMap.put("[考拉熊]", R.drawable.emoji_1f428);
        sQQFaceMap.put("[乖乖兔]", R.drawable.emoji_1f42d);
        sQQFaceMap.put("[奶牛]", R.drawable.emoji_1f42e);
        sQQFaceMap.put("[老虎]", R.drawable.emoji_1f42f);
        sQQFaceMap.put("[乖乖鼠]", R.drawable.emoji_1f430);
        sQQFaceMap.put("[乖乖熊]", R.drawable.emoji_1f43b);
        sQQFaceMap.put("[白熊]", R.drawable.emoji_1f43c);
        sQQFaceMap.put("[老鼠]", R.drawable.emoji_1f439);
        sQQFaceMap.put("[牛]", R.drawable.emoji_1f402);
        sQQFaceMap.put("[黑牛]", R.drawable.emoji_1f403);
        sQQFaceMap.put("[狐狸]", R.drawable.emoji_1f43a);

package com.ggb.nirvanaclub.modules.laboratory.ugame
...
import com.ggb.nirvanaclub.modules.laboratory.ugame.camera.AutoFitTextureView
import com.my.ugame.GameController
import com.my.ugame.GameState
import com.my.ugame.PermissionUtils
...
import kotlinx.android.synthetic.main.activity_ugame_fullscreen.*
...
class FullscreenActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        setContentView(R.layout.activity_ugame_fullscreen)
...
//                        score.text = "DANGER\nAHEAD"
                    ...
                    is GameState.Over ->
                        AlertDialog.Builder(this)
                            .setMessage("游戏结束！阿熊成功探险了 ${it.score / 10f} 米! ")

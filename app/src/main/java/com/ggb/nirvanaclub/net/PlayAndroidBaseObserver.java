...
public abstract class PlayAndroidBaseObserver<T> implements Observer<PlayAndroidHttpResult<T>> {
    protected Context mContext;
    Boolean doShow = false;

    private LoadingDialog loadingDialog;

    public PlayAndroidBaseObserver(Context cxt, Boolean doShow) {
        this.mContext = cxt;
        this.doShow = doShow;
        if(cxt!=null){
    ...
    public PlayAndroidBaseObserver(Context cxt) {
        this.mContext = cxt;
    }
    public PlayAndroidBaseObserver() {
    ...
    @Override
    public void onNext(PlayAndroidHttpResult<T> tBaseEntity) {
     ...
     * @throws Exception
     */  
    protected abstract void onSuccess(PlayAndroidHttpResult<T> t) throws Exception;
     ...
     * @throws Exception
     */  
    protected void onCodeError(PlayAndroidHttpResult<T> t) throws Exception {}
